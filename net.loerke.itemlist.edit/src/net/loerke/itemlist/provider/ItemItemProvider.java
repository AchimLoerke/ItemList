...
/**
 * This is the item provider adapter for a {@link net.loerke.itemlist.Item} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Item_is_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Item_is_feature", "_UI_Item_type"),
				 ItemlistPackage.Literals.ITEM__IS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_Item_type");
	}
