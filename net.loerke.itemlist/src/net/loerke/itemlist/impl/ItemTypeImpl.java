 ...
 * <ul>
 *   <li>{@link net.loerke.itemlist.impl.ItemTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ItemTypeImpl extends EObjectImpl implements ItemType {
	...
	protected EClass eStaticClass() {
		return ItemlistPackage.Literals.ITEM_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ItemlistPackage.ITEM_TYPE__NAME, oldName, name));
	}
